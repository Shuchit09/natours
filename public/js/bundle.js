...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new maptilersdk.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).setMaxWidth("300px").addTo(map);
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, res, _error$response, message, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          message = ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _t.message || "Something went wrong!";
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var stripe, session, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          ...
          (0, _alert.showAlert)('error', 'Stripe library failed to load.');
          return _context.a(2);
        case 1:
          stripe = Stripe('pk_test_51RW0rM7W2Z3LchUGiXzu5WKXBzuorzMee3JlAoGrdF4CZy2vXgb8NoBPKAXj7IlkrePjexXX3KkjQF2slSZF8a1G00R5LLJKeV');
          _context.n = 2;
          return (0, _axios.default)({
            method: 'GET',
        ...
        case 4:
          ...
          _t = _context.v;
          console.error(_t);
          (0, _alert.showAlert)('error', ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _t.message || 'Something went wrong');
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // this will be treated as form
...
},{"./maptiler":"maptiler.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
